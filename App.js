  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Text style={{color: "#183446", fontSize: 20}}>Player 1 starts with X</Text>
        ...
        <View style={{paddingTop: 50}} />
        <Button style={{borderRadius: 8, padding: 8, margin: 8}} color="#01BAEF" title="New Game" onPress={this.onNewGamePress}/>
